...
function agrega_dns(){
echo -e " Escriba el HOST DNS que desea Agregar"
read -p " [NewDNS]: " SDNS
...
echo -e "\033[1;32m     INSTALADOR OPENVPN SERVER"
#msg -bar
...
echo -e "[\033[1;31m-\033[1;33m]\033[1;32m ───────────────── /// ─────────────────\033[1;33m"
echo -e "Que protocolo necesitas para las conexiones OpenVPN?"
#msg -bar
...
echo -e "[\033[1;31m-\033[1;33m]\033[1;32m ───────────────── /// ─────────────────\033[1;33m"
echo -e "Que puerto necesitas en OpenVPN (Default 1194)?"
#msg -bar
	read -p "Puerto: " -e -i 1194 PORT
#msg -bar
echo -e "Cual DNS usaras en tu VPN?"
#msg -bar
...
#CIPHER
echo -e "[\033[1;31m-\033[1;33m]\033[1;32m ───────────────── /// ─────────────────\033[1;33m"
echo -e " Elija que codificacion desea para el canal de datos:"
#msg -bar
echo "   1) AES-128-CBC"
echo "   2) AES-192-CBC"
echo "   3) AES-256-CBC"
...
echo -e "[\033[1;31m-\033[1;33m]\033[1;32m ───────────────── /// ─────────────────\033[1;33m"
echo -e " Estamos listos para configurar su servidor OpenVPN"
#msg -bar
...
exit 0' > $RCLOCAL
	...
	# 
	echo "# OVPN_ACCESS_SERVER_PROFILE=VpsPack
client
dev tun
proto $PROTOCOL
sndbuf 0
...
#msg -bar
echo -e " Ahora cree una cuenta SSH (.ovpn)!"
#msg -bar
...
echo -e " Parece que no estas ejecutando este instalador en un sistema Debian o Ubuntu"
#msg -bar
return 1
fi
#Pega Interface
...
echo -e "\033[1;32m    INSTALADOR OPENVPN SERVER"
#msg -bar
echo -e " Confirme su IP"; read -p ": " -e -i $IP ip
#msg -bar
echo -e " Que puerto desea usar?"
#msg -bar
    while true; do
...
# OVPN_ACCESS_SERVER_PROFILE=VpsPack
client
nobind
dev tun
...
#Liberando DNS
#msg -bar
echo -e " Ultimo Paso, Configuraciones DNS"
#msg -bar
while [[ $DDNS != @(n|N) ]]; do
echo -ne "\033[1;33m"
...
#msg -bar
echo -e " Ahora crear una SSH para generar el (.ovpn)!"
#msg -bar
return 0
}
edit_ovpn_host () {
echo -e " CONFIGURACION HOST DNS OPENVPN"
#msg -bar
while [[ $DDNS != @(n|N) ]]; do
echo -ne "\033[1;33m"
...
#msg -bar
echo -e " Es Necesario el Reboot del Servidor Para"
echo -e " Para que las configuraciones sean efectudas"
#msg -bar
}
fun_openvpn () {
...
echo -e " OPENVPN YA ESTA INSTALADO"
echo -e "[\033[1;31m-\033[1;33m]\033[1;32m ───────────────── /// ─────────────────\033[1;33m"
echo -e "\033[1;32m [1] >\033[1;37m DESINSTALAR  OPENVPN"
echo -e "\033[1;32m [2] >\033[1;37m EDITAR CONFIGURACION CLIENTE"
echo -e "\033[1;32m [3] >\033[1;37m EDITAR CONFIGURACION SERVIDOR"
echo -e "\033[1;32m [4] >\033[1;37m CAMBIAR HOST DE OPENVPN"
echo -e "\033[1;32m [5] >\033[1;37m INICIAR O PARAR OPENVPN - $OPENBAR"
#msg -bar
